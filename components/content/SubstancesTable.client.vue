          ...
          <table class="w-full table-fixed border-separate border-spacing-0" id="substances-table">
            ...
            <thead class="title">
              <tr class="sticky">
                ...
                <th class="sticky border-b border-teal-600 top-0 bg-[#192539] text-left pt-4 pb-4 pr-4">
                  <button
                    class="sort-toggle"
            ...
            <tbody>
              ...
              >
                ...
                <td class="bg-[#192539] border-b border-teal-600 h-14 p-4 w-1/4 group-hover:bg-[#2b3e5a]">
                  {{ r.category }}
                </td>
